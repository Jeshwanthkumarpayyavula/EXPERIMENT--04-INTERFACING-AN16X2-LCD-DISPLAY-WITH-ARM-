...
3. select the target to be programmed STM32F401RB and click on next 
...
14. After creation of the circuit as per requirements Place them in the Circuits
...
{
	Lcd_cursor(&lcd,0,1);
	Lcd_string(&lcd,"N KUMARTEJA\n");
	Lcd_cursor(&lcd,1,1);
	Lcd_string(&lcd,"212223230132");
...
## Output screen shots of proteus  :
 ![Screenshot 2024-09-23 093012](https://github.com/user-attachments/assets/fa1ac2c1-49aa-4159-b168-b52d797c70b6)

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 

 ![Screenshot 2024-09-23 093034](https://github.com/user-attachments/assets/a045a320-eec7-467a-a2ca-363f6fb5fade)
## Result :
